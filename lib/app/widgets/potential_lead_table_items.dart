...
class PotentialLeadTableItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FittedBox(
      child: Table(
        ...
        children: [
          TableRow(children: [
            _createTableTitleCell(label: 'Month'),
            _createTableTitleCell(label: 'Business Type'),
          ...
          TableRow(children: [
            ...
            _createTableCell(label: '97765446(Sum of all revenue of the month')
          ]),
        ],
      ),
    );
